...
if __name__ == "__main__":
    ...
    if list(style_augmentor.parameters()) == []:
        ...
        loss_fn = torch.nn.MSELoss(
            reduction='mean')  ## loss function to optimize maxstyle parameters.here we use MSE for simplicity. In practice, we can use other loss functions, such as CrossEntropyLoss for the segmentation task, etc
