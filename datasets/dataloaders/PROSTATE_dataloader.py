...
class PROSTATE_dataset(data.Dataset):
    def __init__(self, root, img_list, label_list, target_size=(384,384), batch_size=None, img_normalize=True):
        super().__init__()
        self.root = root
    ...
    def __getitem__(self, item):
        ...
        return img_npy, label_npy, self.name_pool[item]+str(slice),clean_npy
